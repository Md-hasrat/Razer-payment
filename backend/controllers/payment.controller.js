...
//   // Basic validation
//   if (!razorpay_order_id || !razorpay_payment_id || !razorpay_signature) {
//     console.error("Missing Razorpay callback parameters.");
...
//         success: true,
//         message: "Duplicate payment. Already processed.",
//         status: "duplicate",
...
//   } catch (err) {
//     console.error("Server error during payment verification:", err);
